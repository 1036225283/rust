...
decshake(128) decshake(256) deckeccak(224) deckeccak(256) deckeccak(384)
    deckeccak(512)

        static __constant uint8_t rho[24] = {1,  3,  6,  10, 15, 21, 28, 36,
                                             45, 55, 2,  14, 27, 41, 56, 8,
                                             25, 43, 62, 18, 39, 61, 20, 44};

static __constant uint8_t pi[24] = {10, 7,  11, 17, 18, 3,  5,  16,
                                    8,  21, 24, 4,  15, 23, 19, 13,
                                    12, 2,  20, 14, 22, 9,  6,  1};

static __constant uint64_t RC[24] = {1,
                                     0x8082,
                                     0x800000000000808a,
                                     0x8000000080008000,
                                     0x808b,
